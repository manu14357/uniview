 ...
 */
export interface UvTrBatchGeometryUserData {
  objectId?: string
  /**
...
export interface UvTrBatchGeometryState {
 ...
 */
export type UvTrVertexBatchGeometryInfo = UvTrBatchGeometryUserData &
  UvTrBatchGeometryState & {
 ...
 */
export type UvTrIndexedBatchGeometryInfo = UvTrVertexBatchGeometryInfo & {
 ...
 */
export type UvTrBatchedGeometryInfo = UvTrIndexedBatchGeometryInfo
