...
export type UvTrBatchedGeometryInfo = UvTrVertexBatchGeometryInfo

const _box = /*@__PURE__*/ new THREE.Box3()
const _vector = /*@__PURE__*/ new THREE.Vector3()

const UvTrBatchedPointBase = createUvTrBatchedMixin<UvTrBatchedGeometryInfo>(
  THREE.Points,
  {
    typeName: 'UvTrBatchedPoint',
 ...
 */
export class UvTrBatchedPoint extends UvTrBatchedPointBase {
  ...
  private _validateGeometry(geometry: THREE.BufferGeometry) {
    validateGeometry(this.geometry, geometry, 'UvTrBatchedPoint', false)
  }
    ...
    const newMaxVertexCount =
      positionAttribute == null
        ...
        : growCapacityIfNeeded({
            ...
            growthFactor: UvTrBatchedPoint.GROWTH_FACTOR
          })
  ...
  setGeometryInfo(geometryId: number, userData: UvTrBatchGeometryUserData) {
    if (geometryId >= this._geometryCount) {
      throw new Error('UvTrBatchedPoint: Maximum geometry count reached.')
    }
  ...
  setGeometryAt(geometryId: number, geometry: THREE.BufferGeometry) {
    ...
    applyGeometryAt(geometryInfo, batchGeometry, geometry, 'UvTrBatchedPoint')
