...
const UvTrBatchedMeshBase = createUvTrBatchedMixin<UvTrBatchedGeometryInfo>(
  THREE.Mesh,
  {
    typeName: 'UvTrBatchedMesh',
 ...
 */
export class UvTrBatchedMesh extends UvTrBatchedMeshBase {
  ...
  private _validateGeometry(geometry: THREE.BufferGeometry) {
    validateGeometry(this.geometry, geometry, 'UvTrBatchedMesh', true)
  }
    ...
    const newMaxIndexCount =
      index == null
        ...
        : growCapacityIfNeeded({
            ...
            growthFactor: UvTrBatchedMesh.GROWTH_FACTOR
          })
  ...
  setGeometryInfo(geometryId: number, userData: UvTrBatchGeometryUserData) {
    if (geometryId >= this._geometryCount) {
      throw new Error('UvTrBatchedMesh: Maximum geometry count reached.')
    }
  ...
  setGeometryAt(geometryId: number, geometry: THREE.BufferGeometry) {
    ...
    const geometryInfo = this._geometryInfo[geometryId]
    applyGeometryAt(geometryInfo, batchGeometry, geometry, 'UvTrBatchedMesh')
