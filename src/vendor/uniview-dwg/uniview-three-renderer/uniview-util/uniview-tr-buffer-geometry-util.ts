 ...
 * @internal
 */
export class UvTrBufferGeometryUtil {
  /**
  ...
  public static toNonIndexed(
    ...
    for (const name in geometry.attributes) {
      newGeometry.setAttribute(
        name,
        UvTrBufferGeometryUtil.createGeometryAttributeByIndex(
  ...
  static createBufferGeometryByPoints(points: UvGePoint3dLike[]) {
  ...
  static computeLineDistance(line: THREE.Line) {
    ...
    if (geometry.index) {
      geometry = UvTrBufferGeometryUtil.toNonIndexed(geometry)
    }
