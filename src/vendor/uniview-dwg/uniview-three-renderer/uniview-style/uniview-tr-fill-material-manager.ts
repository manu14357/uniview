...
} from './uniview-tr-hatch-pattern-shaders'
import { UvTrMaterialManager } from './uniview-tr-material-manager'

export interface UvTrFillMaterialOptions {
 ...
 */
export class UvTrFillMaterialManager extends UvTrMaterialManager<UvTrFillMaterialOptions> {
  /**
   * Create either MeshBasicMaterial or hatch shader material
   */
  protected createMaterialImpl(
    traits: UvGiSubEntityTraits,
    options: UvTrFillMaterialOptions
  ): THREE.Material {
  ...
  private createHatchShaderMaterial(
    ...
    const patternLines: UvTrPatternLine[] = []
  ...
  private createMeshBasicMaterial(traits: UvGiSubEntityTraits): THREE.Material {
  ...
  protected buildKey(
    traits: UvGiSubEntityTraits,
    _options: UvTrFillMaterialOptions
  ): string {
    const style = traits.fillType
