import { UvGePoint3dLike, UvGiSubEntityTraits } from '@uniview/data-model'
...
export class UvTrLine extends UvTrEntity {
  ...
  constructor(
    ...
    UvTrBufferGeometryUtil.computeLineDistances(line)
    this.add(line)
  }
