...
/**
 * Manages transient UvTrEntity objects in a dedicated THREE.Group.
 */
export class UvTrTransientManager {
  private readonly scene: THREE.Scene
  private readonly transientGroup: THREE.Group

  /** Mapping from transient ID → UvTrEntity */
  private readonly entities: Map<string, UvTrEntity>
   ...
   *
   * @param entity The UvTrEntity to add.
   */
  add(entity: UvTrEntity): void {
   ...
   */
  update(newEntity: UvTrEntity): void {
   ...
   */
  get(id: string): UvTrEntity | undefined {
