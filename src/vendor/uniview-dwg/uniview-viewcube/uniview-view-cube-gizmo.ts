...
import { DEFAULT_FACENAMES, FaceNames } from './uniview-face-names'
import { FACES } from './uniview-view-cube-data'
import { ViewCube } from './uniview-view-cube'
import { FixedPosGizmo, ObjectPosition } from './uniview-fixed-pos-gizmo'
...
export interface ViewCubeOptions {
  ...
  pos?: ObjectPosition
  /**
   * Size of area occupied by view cube. Because width and height of this area is same, it is single value.
