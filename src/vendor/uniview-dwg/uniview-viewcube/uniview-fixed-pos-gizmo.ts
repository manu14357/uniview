...
/**
 * Enum to define position of the gizmo.
 */
...
/**
 * A customizable gizmo with fixed position in viewport
 */
...
> extends THREE.Object3D<TEventMap> {
   ...
   * @param dimension Size of area occupied by this gizmo. Because width and height of this area is same,
   * it is single value. The real size of the object will be calculated automatically considering rotation.
