import { UvGiBaseLineStyle } from '@uniview/graphics'
 ...
 */
export class UvDbLinetypeTableRecord extends UvDbSymbolTableRecord {
  private _linetype: UvGiBaseLineStyle
   ...
   */
  constructor(linetype: UvGiBaseLineStyle) {
    super()
