import { UvGiTextStyle } from '@uniview/graphics'
 ...
 * @example
 * ```typescript
 * const textStyle = new UvGiBaseTextStyle();
 * textStyle.name = 'MyStyle';
 * textStyle.font = 'Arial';
 * const record = new UvDbTextStyleTableRecord(textStyle);
 * ```
 */
export class UvDbTextStyleTableRecord extends UvDbSymbolTableRecord {
  /** The text style configuration */
  private _textStyle: UvGiTextStyle
  /** Whether text drawn with this style is vertical */
  private _isVertical: boolean

  /**
   * Creates a new UvDbTextStyleTableRecord instance.
   *
   ...
   * ```
   */
  constructor(textStyle: UvGiTextStyle) {
    super()
