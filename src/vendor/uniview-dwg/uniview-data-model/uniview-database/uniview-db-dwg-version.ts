export interface UvDbDwgVersionEntry {
  name: string
  value: number
}

/**
 * Please refer to AutoCAD ObjectARX enum AcDb::UvDbDwgVersion for more details.
 * https://help.autodesk.com/view/OARX/2023/ENU/?guid=OARX-RefGuide-AcDb__AcDbDwgVersion
 */
const dwgVersions: UvDbDwgVersionEntry[] = [
  { name: 'AC1.2', value: 1 },
  { name: 'AC1.40', value: 2 },
  { name: 'AC1.50', value: 3 },
  { name: 'AC2.20', value: 4 },
 ...
 */
export class UvDbDwgVersion {
  /**
   * DWG version name as defined in `UvDbDwgVersionEntry.name`.
   */
  name: string
  /**
   * Numeric DWG version value as defined in `UvDbDwgVersionEntry.value`.
   */
  value: number
  ...
  constructor(nameOrValue: string | number) {
    ...
    throw new Error('Invalid constructor argument for UvDbDwgVersion')
  }
}
