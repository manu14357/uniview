import { UvDbObject, UvDbObjectId, UvDbOpenMode } from '../../uniview-base'
 ...
 */
export class UvDbTransaction {
  /** Objects opened in this transaction */
  private readonly openedObjects = new Map<UvDbObjectId, UvDbObject>()

  /** Snapshots of objects before modification */
  private readonly originalStates = new Map<UvDbObjectId, unknown>()
   ...
   */
  getObject<T extends UvDbObject>(
    ...
    if (!this.openedObjects.has(objectId)) {
      ...
      if (mode === UvDbOpenMode.kForWrite) {
   ...
   */
  protected lookupObject<T extends UvDbObject>(
    objectId: UvDbObjectId,
    _openErased: boolean
  ): T {
