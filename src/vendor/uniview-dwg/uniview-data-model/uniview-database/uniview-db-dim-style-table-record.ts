...
import {
  ...
  UvDbSymbolTableRecordAttrs
} from './uniview-db-symbol-table-record'
 ...
 */
export enum UvDbDimTextHorizontal {
 ...
 */
export enum UvDbDimTextVertical {
 ...
 */
export enum UvDbDimZeroSuppression {
 ...
 */
export enum UvDbDimZeroSuppressionAngular {
 ...
 */
export enum UvDbDimVerticalJustification {
 ...
 */
export interface UvDbDimStyleTableRecordAttrs
  extends UvDbSymbolTableRecordAttrs {
  ...
  dimtad: UvDbDimTextVertical
  /** Zero suppression for primary units */
  dimzin: UvDbDimZeroSuppression
  /** Zero suppression for angular dimensions */
  dimazin: UvDbDimZeroSuppressionAngular
 ...
 */
export class UvDbDimStyleTableRecord extends UvDbSymbolTableRecord<UvDbDimStyleTableRecordAttrs> {
  static DEFAULT_DIM_VALUES: UvDbDimStyleTableRecordAttrs = {
    name: '',
    dimpost: '',
    dimapost: '',
    dimscale: 1.0,
    ...
    dimtad: UvDbDimTextVertical.Center,
    // TODO: Its initial value is 0 (imperial) or 8 (metric)
    dimzin: UvDbDimZeroSuppression.Feet,
    dimazin: UvDbDimZeroSuppressionAngular.None,
    dimalt: 0,
    ...
    dimdsep: '.',
    dimtmove: 0,
    dimjust: UvDbDimTextHorizontal.Center,
    dimsd1: 0,
    dimsd2: 0,
    // TODO: Its initial value is 1 (imperial) or 0 (metric)
    dimtolj: UvDbDimVerticalJustification.Bottom,
    // TODO: Its initial value is 0 (imperial) or 8 (metric)
    dimtzin: UvDbDimZeroSuppression.Feet,
    dimaltz: UvDbDimZeroSuppression.Feet,
    dimalttz: UvDbDimZeroSuppression.Feet,
    dimfit: 0,
    dimupt: 0,
    dimatfit: 3,
    dimtxsty: 'Standard',
  ...
  constructor(
    attrs?: Partial<UvDbDimStyleTableRecordAttrs>,
    defaultAttrs?: Partial<UvDbDimStyleTableRecordAttrs>
  ) {
    attrs = attrs || {}
    defaults(attrs, UvDbDimStyleTableRecord.DEFAULT_DIM_VALUES)
  ...
  set dimtad(value: UvDbDimTextVertical) {
  ...
  set dimzin(value: UvDbDimZeroSuppression) {
  ...
  set dimazin(value: UvDbDimZeroSuppressionAngular) {
  ...
  set dimtolj(value: UvDbDimVerticalJustification) {
  ...
  set dimtzin(value: UvDbDimZeroSuppression) {
  ...
  set dimaltz(value: UvDbDimZeroSuppression) {
  ...
  set dimalttz(value: UvDbDimZeroSuppression) {
