 ...
 * @example
 * ```typescript
 * const isMetric = isMetricUnits(UvDbUnitsValue.Millimeters); // true
 * const isMetric2 = isMetricUnits(UvDbUnitsValue.Inches); // false
 * ```
 */
export function isMetricUnits(units: UvDbUnitsValue) {
  return (
    units == UvDbUnitsValue.Millimeters ||
    units == UvDbUnitsValue.Centimeters ||
    units == UvDbUnitsValue.Meters ||
    units == UvDbUnitsValue.Kilometers ||
    units == UvDbUnitsValue.Nanometers ||
    units == UvDbUnitsValue.Microns ||
    units == UvDbUnitsValue.Decimeters ||
    units == UvDbUnitsValue.Dekameters ||
    units == UvDbUnitsValue.Hectometers ||
    units == UvDbUnitsValue.Gigameters
  )
}
 ...
 * @example
 * ```typescript
 * const isImperial = isImperialUnits(UvDbUnitsValue.Inches); // true
 * const isImperial2 = isImperialUnits(UvDbUnitsValue.Millimeters); // false
 * ```
 */
export function isImperialUnits(units: UvDbUnitsValue) {
  return (
    units == UvDbUnitsValue.Inches ||
    units == UvDbUnitsValue.Feet ||
    units == UvDbUnitsValue.Miles ||
    units == UvDbUnitsValue.Microinches ||
    units == UvDbUnitsValue.Mils ||
    units == UvDbUnitsValue.Yards ||
    units == UvDbUnitsValue.USSurveyFeet
  )
}
