 ...
 */
export class UvDb2dVertex extends UvDbEntity {
  ...
  /** The vertex type */
  private _vertexType: UvDb2dVertexType
  ...
  constructor() {
    ...
    this._startWidth = 0
    this._endWidth = 0
    this._vertexType = UvDb2dVertexType.Vertex
  }
   ...
   * owning UvDb2dPolyline only for historical purposes.
   *
   ...
   */
  get vertexType(): UvDb2dVertexType {
   ...
   */
  set vertexType(value: UvDb2dVertexType) {
