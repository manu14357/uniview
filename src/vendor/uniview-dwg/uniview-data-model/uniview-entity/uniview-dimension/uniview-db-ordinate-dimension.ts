 ...
 */
export class UvDbOrdinateDimension extends UvDbDimension {
  /** The entity type name */
  static override typeName: string = 'OrdinateDimension'

  private _definingPoint: UvGePoint3d
  private _leaderEndPoint: UvGePoint3d
   ...
   */
  constructor(
    definingPoint: UvGePoint3dLike,
    leaderEndPoint: UvGePoint3dLike,
    dimText: string | null = null,
    dimStyle: string | null = null
  ) {
    super()
    this._definingPoint = new UvGePoint3d().copy(definingPoint)
    this._leaderEndPoint = new UvGePoint3d().copy(leaderEndPoint)
  ...
  set definingPoint(value: UvGePoint3d) {
  ...
  set leaderEndPoint(value: UvGePoint3d) {
