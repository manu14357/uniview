 ...
 */
export class UvDbDiametricDimension extends UvDbDimension {
  /** The entity type name */
  static override typeName: string = 'DiametricDimension'

  private _chordPoint: UvGePoint3d
  private _farChordPoint: UvGePoint3d
  ...
  constructor(
    ...
    this._farChordPoint = new UvGePoint3d().copy(farChordPoint)
  ...
  set farChordPoint(value: UvGePoint3d) {
   ...
   * @protected
   */
  protected drawLines(renderer: UvGiRenderer, lines: UvDbLine[]) {
   ...
   */
  private sortLines(lines: UvDbLine[]) {
    // Function to compare positions of points
    const comparePoints = (a: UvGePoint3d, b: UvGePoint3d): number => {
