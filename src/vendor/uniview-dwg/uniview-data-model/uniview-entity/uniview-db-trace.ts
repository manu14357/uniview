 ...
 * const trace = new UvDbTrace();
 * trace.setPointAt(0, new UvGePoint3d(0, 0, 0));
 * trace.setPointAt(1, new UvGePoint3d(10, 0, 0));
 * trace.setPointAt(2, new UvGePoint3d(10, 5, 0));
 * trace.setPointAt(3, new UvGePoint3d(0, 5, 0));
 *
 ...
 * ```
 */
export class UvDbTrace extends UvDbCurve {
  ...
  private _vertices: [UvGePoint3d, UvGePoint3d, UvGePoint3d, UvGePoint3d]
   ...
   * ```
   */
  getPointAt(index: number): UvGePoint3d {
   ...
   * ```
   */
  setPointAt(index: number, point: UvGePointLike) {
  ...
  get geometricExtents(): UvGeBox3d {
    return new UvGeBox3d().setFromPoints(this._vertices)
  }
  ...
  subWorldDraw(renderer: UvGiRenderer) {
    const polyline = new UvGePolyline2d(this._vertices, true)
