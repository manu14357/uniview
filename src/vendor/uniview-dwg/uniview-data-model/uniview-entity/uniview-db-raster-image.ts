 ...
 */
export enum UvDbRasterImageClipBoundaryType {
  /** Undefined state */
  Invalid = 0,
 ...
 */
export enum UvDbRasterImageImageDisplayOpt {
 ...
 *
 * The UvDbRasterImage entity (or "image entity") works with the UvDbRasterImageDef object
 ...
 * const rasterImage = new UvDbRasterImage();
 * rasterImage.position = new UvGePoint3d(0, 0, 0);
 * rasterImage.width = 100;
 * rasterImage.height = 75;
 * rasterImage.scale = new UvGeVector2d(1, 1);
 ...
 * ```
 */
export class UvDbRasterImage extends UvDbEntity {
  ...
  private _scale: UvGeVector2d
  /** The clip boundary type */
  private _clipBoundaryType: UvDbRasterImageClipBoundaryType
  /** The clip boundary points */
  private _clipBoundary: UvGePoint2d[]
  /** The image definition object ID */
  private _imageDefId: UvDbObjectId
   ...
   * ```typescript
   * const rasterImage = new UvDbRasterImage();
   * rasterImage.position = new UvGePoint3d(10, 20, 0);
  ...
  constructor() {
    ...
    this._scale = new UvGeVector2d(1, 1)
    this._rotation = 0
    this._clipBoundaryType = UvDbRasterImageClipBoundaryType.Rect
    this._clipBoundary = []
  ...
  set position(value: UvGePoint3d) {
  ...
  set clipBoundaryType(value: UvDbRasterImageClipBoundaryType) {
  ...
  set clipBoundary(value: UvGePoint2d[]) {
    this._clipBoundary = []
  ...
  set imageDefId(value: UvDbObjectId) {
  ...
  protected boundaryPath() {
    ...
    if (this.isClipped && this._clipBoundary.length > 3) {
      ...
      const ocsBox = new UvGeBox2d()
      ocsBox.setFromPoints(this._clipBoundary)
      const translation = new UvGePoint2d()
      ...
      this._clipBoundary.forEach(point => {
        ...
        points.push(new UvGePoint3d(x, y, this._position.z))
      })
    } else {
...
const _point1 = /*@__PURE__*/ new UvGePoint2d()
const _point2 = /*@__PURE__*/ new UvGePoint2d()
