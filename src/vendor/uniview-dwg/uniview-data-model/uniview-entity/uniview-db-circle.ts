 ...
 * ```
 */
export class UvDbCircle extends UvDbCurve {
   ...
   * const circleInYZ = new UvDbCircle(
   *   new UvGePoint3d(0, 0, 0),
   *   10,
   *   UvGeVector3d.X_AXIS
   * );
   ...
   * @example
   * ```typescript
   * circle.center = new UvGePoint3d(5, 5, 0);
   * ```
   */
