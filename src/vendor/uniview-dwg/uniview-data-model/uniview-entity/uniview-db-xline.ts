 ...
 * const xline = new UvDbXline();
 * xline.basePoint = new UvGePoint3d(0, 0, 0);
 * xline.unitDir = new UvGeVector3d(1, 0, 0);
 *
 ...
 * ```
 */
export class UvDbXline extends UvDbCurve {
   ...
   * ```typescript
   * const xline = new UvDbXline();
   * xline.basePoint = new UvGePoint3d(5, 10, 0);
   * xline.unitDir = new UvGeVector3d(0, 1, 0); // Positive Y direction
   * ```
   */
  constructor() {
    super()
   ...
   * @example
   * ```typescript
   * xline.basePoint = new UvGePoint3d(10, 20, 0);
   * ```
   */
   ...
   * @example
   * ```typescript
   * xline.unitDir = new UvGeVector3d(0, 0, 1); // Positive Z direction
   * ```
   */
