 ...
 */
export enum UvDbTextHorizontalMode {
  /** Left-aligned text */
  LEFT = 0,
  /** Center-aligned text */
  CENTER = 1,
 ...
 */
export enum UvDbTextVerticalMode {
 ...
 * const text = new UvDbText();
 * text.textString = "Hello, World!";
 * text.position = new UvGePoint3d(0, 0, 0);
 * text.height = 2.5;
 * text.horizontalMode = UvDbTextHorizontalMode.CENTER;
 * text.verticalMode = UvDbTextVerticalMode.BASELINE;
 *
 ...
 * ```
 */
export class UvDbText extends UvDbEntity {
  ...
  private _horizontalMode: UvDbTextHorizontalMode
  /** The vertical alignment mode */
  private _verticalModel: UvDbTextVerticalMode
  /** The text style name */
   ...
   * text.position = new UvGePoint3d(10, 20, 0);
   * text.height = 3.0;
   * ```
   */
  constructor() {
    ...
    this._rotation = 0
    this._oblique = 0
    this._horizontalMode = UvDbTextHorizontalMode.LEFT
    this._verticalModel = UvDbTextVerticalMode.MIDDLE
    this._styleName = ''
    this._widthFactor = 1
  }
   ...
   * @example
   * ```typescript
   * text.position = new UvGePoint3d(15, 25, 0);
   * ```
   */
   ...
   * ```
   */
  set horizontalMode(value: UvDbTextHorizontalMode) {
   ...
   * ```
   */
  set verticalMode(value: UvDbTextVerticalMode) {
   ...
   * ```
   */
  protected getTextStyle(): UvGiTextStyle {
  ...
  subWorldDraw(
    ...
    const mtextData: UvGiMTextData = {
      ...
      drawingDirection: UvGiMTextFlowDirection.BOTTOM_TO_TOP,
      attachmentPoint: UvGiMTextAttachmentPoint.BottomLeft
    }
