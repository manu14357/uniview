...
export class UvDb3dPolyline extends UvDbCurve {
  ...
  constructor(
    ...
    super()
    this._polyType = type
    this._geo = new UvGePolyline2d(vertices, closed)
  }
   ...
   */
  set polyType(value: UvDbPoly3dType) {
  ...
  subWorldDraw(renderer: UvGiRenderer) {
    ...
    tmp.forEach(point =>
      points.push(new UvGePoint3d().set(point.x, point.y, 0))
    )
