...
export class UvDbEllipse extends UvDbCurve {
   ...
   * const fullEllipse = new UvDbEllipse(
   *   new UvGePoint3d(0, 0, 0),
   *   UvGeVector3d.Z_AXIS,
   *   UvGeVector3d.X_AXIS,
   *   20, // major radius
   ...
   * const quarterEllipse = new UvDbEllipse(
  ...
  constructor(
    ...
    super()
    this._geo = new UvGeEllipseArc3d(
      center,
      normal,
      majorAxis,
      majorAxisRadius,
   ...
   * @example
   * ```typescript
   * ellipse.center = new UvGePoint3d(5, 5, 0);
   * ```
   */
   ...
   * @example
   * ```typescript
   * ellipse.normal = UvGeVector3d.Y_AXIS;
   * ```
   */
