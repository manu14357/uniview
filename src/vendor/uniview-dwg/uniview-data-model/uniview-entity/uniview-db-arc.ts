...
export class UvDbArc extends UvDbCurve {
   ...
   * const semicircle = new UvDbArc(
   *   new UvGePoint3d(10, 20, 0),
   *   25,
   *   0,
   *   Math.PI
   * );
  ...
  constructor(
    ...
    startAngle: number,
    endAngle: number,
    normal: UvGeVector3dLike = UvGeVector3d.Z_AXIS
  ) {
    super()
    this._geo = new UvGeCircArc3d(
      center,
      radius,
      startAngle,
      endAngle,
   ...
   * @example
   * ```typescript
   * arc.center = new UvGePoint3d(5, 5, 0);
   * ```
   */
  set center(value: UvGePoint3dLike) {
   ...
   * @example
   * ```typescript
   * arc.normal = new UvGeVector3d(0, 0, 1);
   * ```
   */
        ...
        this.getGeneralProperties(),
        {
          ...
          properties: [
            ...
            },
            {
              ...
              editable: false,
              accessor: {
                get: () => UvGeMathUtil.radToDeg(Math.abs(this._geo.deltaAngle))
              }
            },
            {
              name: 'area',
   ...
   * @example
   * ```typescript
   * const translationMatrix = UvGeMatrix3d.translation(10, 0, 0);
