import { UvGeBox2d, UvGeBox3d } from '@uniview/geometry'
 ...
 *
 * Layout objects are stored in an UvDbDictionary object with an ACAD_LAYOUT key,
 ...
 * layout.tabOrder = 1;
 * layout.limits = new UvGeBox2d();
 * ```
 */
export class UvDbLayout extends UvDbObject {
   ...
   * @example
   * ```typescript
   * layout.extents = new UvGeBox3d();
   * ```
   */
  set extents(value: UvGeBox3d) {
