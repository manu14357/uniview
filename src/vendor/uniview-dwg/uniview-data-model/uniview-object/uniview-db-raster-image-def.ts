...
/**
 * The UvDbRasterImageDef object (or "image definition object") works with the UvDbRasterImage entity
 ...
 * in a special UvDbDictionary named ISM_RASTER_IMAGE_DICT.
 *
 * @example
 * ```typescript
 * const imageDef = new UvDbRasterImageDef();
 * imageDef.sourceFileName = '/path/to/image.jpg';
 * ```
 */
export class UvDbRasterImageDef extends UvDbObject {
  /** The path name of the externally referenced image file */
  private _sourceFileName: string

  /**
   * Creates a new UvDbRasterImageDef instance.
   *
   * @example
   * ```typescript
   * const imageDef = new UvDbRasterImageDef();
