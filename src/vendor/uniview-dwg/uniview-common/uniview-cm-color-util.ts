...
export class UvCmColorUtil {
   ...
   * const redColor = UvCmColorUtil.getAcadColor(1); // returns 16711680 (0xFF0000)
   * ```
   *
   * @example
   * ```typescript
   * // Get special inheritance colors
   * const byBlock = UvCmColorUtil.getAcadColor(0);   // "ByBlock" color
   * const byLayer = UvCmColorUtil.getAcadColor(256); // "ByLayer" color
   * ```
   */
   ...
   * const redColor = UvCmColorUtil.getColorByName("red"); // returns 16711680 (0xFF0000)
   * const blueColor = UvCmColorUtil.getColorByName("blue"); // returns 255 (0x0000FF)
   * ```
   *
   * @example
   * ```typescript
   * // Handle undefined for unknown color names
   * const unknownColor = UvCmColorUtil.getColorByName("unknown"); // returns undefined
   * ```
   */
