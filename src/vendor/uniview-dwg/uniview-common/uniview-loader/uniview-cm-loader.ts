 ...
 */
export type UvCmLoaderProgressCallback = (progress: ProgressEvent) => void
 ...
 * @example
 * ```typescript
 * class MyCustomLoader extends UvCmLoader {
 *   load(url: string, onLoad: (data: MyDataType) => void, onProgress?: UvCmLoaderProgressCallback, onError?: UvCmOnErrorCallback): void {
 ...
 * ```
 */
export abstract class UvCmLoader {
  readonly manager: UvCmLoadingManager
  /**
  ...
  /**
   * Creates a new UvCmLoader instance.
   ...
   */
  loadAsync(url: string, onProgress: UvCmLoaderProgressCallback) {
