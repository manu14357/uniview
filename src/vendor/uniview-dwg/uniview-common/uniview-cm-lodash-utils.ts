 ...
 * @example
 * ```typescript
 * import { clone } from './uniview-cm-lodash-utils'
 *
 ...
 * @example
 * ```typescript
 * import { defaults } from './uniview-cm-lodash-utils'
 *
 * const object = { a: 1 }
 ...
 * @example
 * ```typescript
 * import { has } from './uniview-cm-lodash-utils'
 *
 ...
 * @example
 * ```typescript
 * import { isEmpty } from './uniview-cm-lodash-utils'
 *
 * isEmpty(null)           // true
 ...
 * @example
 * ```typescript
 * import { isEqual } from './uniview-cm-lodash-utils'
 *
 * isEqual(1, 1)                    // true
