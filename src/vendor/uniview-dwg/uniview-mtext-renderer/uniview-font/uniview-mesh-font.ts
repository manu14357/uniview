...
import { FontData } from './uniview-font'
import { MeshTextShape } from './uniview-mesh-text-shape'
import { ThreeFont } from './uniview-three-font'
...
export class MeshFont extends BaseFont {
  ...
  constructor(fontData: FontData) {
    ...
    if (data instanceof ArrayBuffer) {
      ...
      throw new Error(
        'Invalid font cache data. Please remove font cache database named \'uniview-dwg\' in IndexedDB and try again!'
      )
    }
