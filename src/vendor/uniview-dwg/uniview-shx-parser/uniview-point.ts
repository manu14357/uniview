...
export class ShxPoint {
  ...
  /**
   * Creates a new ShxPoint instance.
   ...
   */
  set(x: number, y: number): ShxPoint {
    this.x = x;
    this.y = y;
    return this;
  }
  ...
  /**
   * Creates a new ShxPoint instance with the same coordinates.
   * @returns A new ShxPoint instance with the same x and y values
   */
  clone(): ShxPoint {
    return new ShxPoint(this.x, this.y);
  }
   ...
   * @returns The point instance for method chaining
   */
  subtract(point: ShxPoint): ShxPoint {
    this.x -= point.x;
    this.y -= point.y;
    return this;
  }
   ...
   * @returns The point instance for method chaining
   */
  multiply(scalar: number): ShxPoint {
    this.x *= scalar;
    this.y *= scalar;
    return this;
  }
   ...
   * @returns The point instance for method chaining
   */
  multiplyScalars(xScalar: number, yScalar: number): ShxPoint {
    this.x *= xScalar;
    this.y *= yScalar;
    return this;
  }
   ...
   * @returns The point instance for method chaining
   */
  divideScalars(xScalar: number, yScalar: number): ShxPoint {
   ...
   */
  distanceTo(point: ShxPoint): number {
...
/**
 * @deprecated Use {@link ShxPoint} instead.
 */
export const Point = ShxPoint
/** @deprecated Use {@link ShxPoint} instead. */
export type Point = ShxPoint
