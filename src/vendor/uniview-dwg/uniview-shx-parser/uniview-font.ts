import { ShxFileReader } from './uniview-file-reader';
import { ShxFontData, ShxFontType } from './uniview-font-data';
import { ShxHeaderParser } from './uniview-header-parser';
import { ShxContentParserFactory } from './uniview-content-parser';
import { ShxShapeParser } from './uniview-shape-parser';
...
export class ShxFont {
  ...
  /**
   * Return true if this font contains glyph of the specified character code.
   * @param code - The character code to check
   * @returns True if this font contains glyph of the specified character code
   */
