...
import type { ShadePlotMode } from '../../../uniview-parser/uniview-objects';
...
export interface ViewportEntity extends CommonDxfEntity {
    ...
    ucsXAxis?: Point3D;
    ucsYAxis?: Point3D;
    ucsId?: string; // ID/handle of UvDbUCSTableRecord if UCS is a named UCS. If not present, then UCS is unnamed
    ucsBaseId?: string; // ID/handle of UvDbUCSTableRecord of base UCS if UCS is orthographic. If it's not exists, taken to be WORLD
