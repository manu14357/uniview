import { UvCmPerformanceCollector } from '@uniview/data-model'
 ...
 * @internal
 */
export class UvApLogCmd extends UvEdCommand {
  ...
  private printSelectionSet(context: UvApContext) {
  ...
  private printStats(context: UvApContext) {
    const stats = (context.view as UvTrView2d).stats
  ...
  private printPerformanceData() {
    UvCmPerformanceCollector.getInstance().printAll()
  }
}
