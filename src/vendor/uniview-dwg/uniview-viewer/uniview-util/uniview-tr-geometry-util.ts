import { UvGeBox2d, UvGeBox3d, UvGePoint2dLike } from '@uniview/data-model'
import * as THREE from 'three'

/**
 * Converts a Three.js Box3 to a CAD geometry UvGeBox3d.
 *
...
const threeBox3dToGeBox3d = (from: THREE.Box3) => {
  return new UvGeBox3d(from.min, from.max)
}

/**
 * Converts a CAD geometry UvGeBox3d to a CAD geometry Box2.
 *
 * @param from - The CAD geometry Box3d to convert
 * @returns The converted CAD geometry Box2
 */
const geBox3dToGeBox2d = (from: UvGeBox3d) => {
  return new UvGeBox2d(
    from.min as unknown as UvGePoint2dLike,
    from.max as unknown as UvGePoint2dLike
  )
}

/**
 * Converts a CAD geometry UvGeBox3d to a Three.js Box3.
 *
 * @param from - The CAD geometry Box3d to convert
 * @returns The equivalent Three.js Box3
 */
const geBox3dToThreeBox3d = (from: UvGeBox3d) => {
...
/**
 * Converts a Three.js Box2 to a CAD geometry UvGeBox2d.
 *
...
const threeBox2dToGeBox2d = (from: THREE.Box2) => {
  return new UvGeBox2d(from.min, from.max)
}
 ...
 */
const geBox2dToThreeBox2d = (from: UvGeBox2d) => {
...
/**
 * Converts a CAD geometry UvGeBox2d to a Three.js Box3 by setting Z dimension to 0.
 *
 * @param from - The CAD geometry Box2d to convert
 * @returns The equivalent Three.js Box3 with Z=0
 */
const geBox2dToThreeBox3d = (from: UvGeBox2d) => {
 ...
 * const cadBox = UvTrGeometryUtil.threeBox3dToGeBox3d(threeBox);
 *
 * // Convert CAD geometry box to Three.js
 * const cadBox2d = new UvGeBox2d();
 * const threeBox2d = UvTrGeometryUtil.goBox2dToThreeBox2d(cadBox2d);
 *
 * // Cross-dimensional conversion
 * const threeBox3d = new THREE.Box3();
 * const cadBox2d = UvTrGeometryUtil.threeBox3dToGeBox2d(threeBox3d);
 * ```
 */
const UvTrGeometryUtil = {
  /** Converts Three.js Box2 to CAD geometry UvGeBox2d */
  threeBo2dToGeBox2d: threeBox2dToGeBox2d,
  /** Converts CAD geometry UvGeBox2d to Three.js Box2 */
  geBox2dToThreeBox2d: geBox2dToThreeBox2d,
  /** Converts Three.js Box3 to CAD geometry UvGeBox3d */
  threeBox3dToGeBox3d: threeBox3dToGeBox3d,
  /** Converts CAD geometry UvGeBox3d to Three.js Box3 */
  geBox3dToThreeBox3d: geBox3dToThreeBox3d,
  /** Converts CAD geometry UvGeBox3d to CAD geometry UvGeBox2d */
  ...
  /** Converts CAD geometry UvGeBox2d to Three.js Box3 (Z=0) */
