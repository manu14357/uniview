...
export type UvTrSpatialIndexBBox = {
  minX: number
  minY: number
  maxX: number
  maxY: number
...
export interface UvTrSpatialIndex<
  T extends UvEdSpatialQueryResultItem = UvEdSpatialQueryResultItem
> {
  /**
   ...
   */
  search(box: UvTrSpatialIndexBBox): T[]
   ...
   * @param box The bounding box in which to search.
   */
  collides(box: UvTrSpatialIndexBBox): boolean
}
