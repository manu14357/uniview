 ...
 */
export type UvEdMarkerType = 'circle' | 'triangle' | 'rect' | 'diamond' | 'x'
...
export class UvEdMarker {
   ...
   */
  public get type(): UvEdMarkerType {
    return this._type
  }
   ...
   */
  public set type(value: UvEdMarkerType) {
    this._type = value
    this.applyShape()
  }
   ...
   */
  public setPosition(pos: UvGePoint2dLike) {
