 ...
 * editor.setCursor(UvEdCorsorType.Grab);
 *
 * // Restore default cursor
 * editor.setCursor(UvEdCorsorType.NoSpecialCursor);
 * ```
 */
export enum UvEdCorsorType {
 ...
 */
export class UvEdCursorManager {
  ...
  private _cursorMap: Map<UvEdCorsorType, string>
  ...
  setCursor(cursorType: UvEdCorsorType) {
    ...
    if (cursorType <= UvEdCorsorType.NoSpecialCursor) {
      element.style.cursor = 'default'
    } else if (cursorType == UvEdCorsorType.Grab) {
