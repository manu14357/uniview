import { UvGePoint2dLike, UvGePoint3d } from '@uniview/data-model'

import { UvEdBaseView } from '../../uniview-view'

/**
 * Options for the UvEdRubberBand preview.
 */
export interface UvEdRubberBandOptions {
  /**
...
/**
 * UvEdRubberBand provides a temporary CAD-style rubber-band preview.
 *
 ...
 */
export class UvEdRubberBand {
  private view: UvEdBaseView
  private basePoint?: UvGePoint3d
  ...
  private options: UvEdRubberBandOptions = {}
   ...
   */
  start(basePoint: UvGePoint2dLike, options?: UvEdRubberBandOptions) {
    this.basePoint = new UvGePoint3d(basePoint)
   ...
   */
  update(targetPoint: UvGePoint2dLike) {
