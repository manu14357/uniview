import { UvEdFloatingInputBox } from './uniview-ed-floating-input-box'
import {
  ...
  UvEdFloatingInputValidationResult
} from './uniview-ed-floating-input-types'

/**
 * Construction options for {@link UvEdFloatingInputBoxes}.
 */
export interface UvEdFloatingInputBoxesOptions<T> {
  /**
 ...
 */
export class UvEdFloatingInputBoxes<T> {
  ...
  /** Always present */
  readonly xInput: UvEdFloatingInputBox

  /** Only present when twoInputs = true */
  readonly yInput?: UvEdFloatingInputBox
   ...
   */
  constructor(options: UvEdFloatingInputBoxesOptions<T>) {
  ...
  setValue(value: UvEdFloatingInputRawData) {
   ...
   */
  private validate(): UvEdFloatingInputValidationResult<T> {
