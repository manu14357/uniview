 ...
 *
 * Inherits common numeric‑prompt behavior from `UvEdPromptNumericalOptions`,
 * and adds integer-specific configuration for minimum and maximum allowed values.
 */
export class UvEdPromptIntegerOptions extends UvEdPromptNumericalOptions {
  private _lowerLimit?: number
  private _upperLimit?: number

  /**
   * Constructs a new `UvEdPromptIntegerOptions`.
   *
