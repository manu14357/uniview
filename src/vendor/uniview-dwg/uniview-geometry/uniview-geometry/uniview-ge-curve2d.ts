import { UvGePoint2d } from '../uniview-math/uniview-ge-point2d'
import { IUvGeShape2d, UvGeShape2d } from './uniview-ge-shape2d'

/**
 * Interface for all 2D curves.
 */
export interface IUvGeCurve2d extends IUvGeShape2d {
  /** Whether the curve is closed (start point equals end point). */
  readonly closed: boolean
  /** Start point of the curve. */
  readonly startPoint: UvGePoint2d
  /** End point of the curve. */
  readonly endPoint: UvGePoint2d
  /** Length of the curve. */
 ...
 * a 2d curve.
 */
export abstract class UvGeCurve2d extends UvGeShape2d implements IUvGeCurve2d {
   ...
   */
  getPoint(_t: number): UvGePoint2d {
    throw new Error('UvGeCurve2d: .getPoint() not implemented.')
  }
