...
import { UvGePlane } from './uniview-ge-plane'
...
export class UvGeBox3d {
   ...
   */
  constructor(
    min: UvGeVector3dLike | undefined = undefined,
    max: UvGeVector3dLike | undefined = undefined
  ) {
    this.min =
      min == null
        ? new UvGeVector3d(+Infinity, +Infinity, +Infinity)
        : new UvGeVector3d(min.x, min.y, min.z)
    this.max =
      max == null
        ? new UvGeVector3d(-Infinity, -Infinity, -Infinity)
        : new UvGeVector3d(max.x, max.y, max.z)
  }
   ...
   */
  set(min: UvGeVector3dLike, max: UvGeVector3dLike) {
    this.min.copy(min)
    this.max.copy(max)
   ...
   * @returns Return this box
   */
  setFromPoints(points: UvGeVector3dLike[]) {
    this.makeEmpty()
   ...
   * @returns Return this box
   */
  setFromCenterAndSize(center: UvGeVector3dLike, size: UvGeVector3dLike) {
   ...
   */
  clone() {
    return new UvGeBox3d().copy(this)
  }
  ...
  get size() {
    return this.isEmpty()
      ? new UvGeVector3d(0, 0, 0)
      : new UvGeVector3d(0, 0, 0).subVectors(this.max, this.min)
  }
   ...
   * @returns
   */
  expandByPoint(point: UvGeVector3dLike) {
    this.min.min(point)
    this.max.max(point)
    return this
  }
   ...
   * @returns Return this box
   */
  expandByVector(vector: UvGeVector3dLike) {
    this.min.sub(vector)
    this.max.add(vector)
   ...
   */
  containsPoint(point: UvGeVector3dLike) {
   ...
   */
  getParameter(point: UvGeVector3dLike, target: UvGeVector3d) {
   ...
   */
  intersectsPlane(plane: UvGePlane) {
   ...
   */
  clampPoint(point: UvGeVector3dLike, target: UvGeVector3d) {
   ...
   */
  distanceToPoint(point: UvGeVector3dLike) {
   ...
   * @returns Return this box
   */
  applyMatrix4(matrix: UvGeMatrix3d) {
   ...
   * @returns Return this box
   */
  translate(offset: UvGeVector3dLike) {
    this.min.add(offset)
    this.max.add(offset)
   ...
   */
  equals(box: UvGeBox3d) {
    return box.min.equals(this.min) && box.max.equals(this.max)
  }
}

const _points = [
  /*@__PURE__*/ new UvGeVector3d(),
  /*@__PURE__*/ new UvGeVector3d(),
  /*@__PURE__*/ new UvGeVector3d(),
  /*@__PURE__*/ new UvGeVector3d(),
  /*@__PURE__*/ new UvGeVector3d(),
