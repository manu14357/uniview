 ...
 */
export class UvGeMatrix2d {
  /**
   * Identity matrix.
   */
  static IDENTITY = Object.freeze(new UvGeMatrix2d())
  /**
   ...
   * @returns Return this matrix
   */
  multiplyMatrices(a: UvGeMatrix2d, b: UvGeMatrix2d) {
    const ae = a.elements
    const be = b.elements
    const te = this.elements
   ...
   * @returns Return this matrix
   */
  getNormalMatrix(matrix4: UvGeMatrix3d) {
   ...
   * @returns Return this matrix
   */
  transposeIntoArray(r: UvGeMatrix3d) {
    const m = this.elements
   ...
   * @returns Return this matrix
   */
  makeTranslation(x: number | UvGeVector2d, y: number) {
    if (x instanceof UvGeVector2d) {
   ...
   */
  clone() {
    return new UvGeMatrix2d().fromArray(this.elements)
  }
}

const _m3 = /*@__PURE__*/ new UvGeMatrix2d()
