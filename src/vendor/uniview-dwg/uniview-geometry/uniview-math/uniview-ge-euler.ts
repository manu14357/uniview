import { clamp } from '../uniview-util'
...
const _matrix = /*@__PURE__*/ new UvGeMatrix3d()
const _quaternion = /*@__PURE__*/ new UvGeQuaternion()

export class UvGeEuler {
   ...
   */
  constructor(x = 0, y = 0, z = 0, order = UvGeEuler.DEFAULT_ORDER) {
    this._x = x
    this._y = y
    this._z = z
    this._order = order
   ...
   */
  clone() {
    return new UvGeEuler(this._x, this._y, this._z, this._order)
  }
   ...
   * @returns Return this euler
   */
  setFromRotationMatrix(m: UvGeMatrix3d, order = this._order, update = true) {
   ...
   * @returns Return this euler
   */
  setFromQuaternion(q: UvGeQuaternion, order: string, update: boolean = true) {
   ...
   * @returns Return this euler
   */
  setFromVector3(v: UvGeVector3d, order = this._order) {
