...
import { UvGeEuler } from './uniview-ge-euler'
import { UvGeMatrix2d } from './uniview-ge-matrix2d'
import { UvGeMatrix3d } from './uniview-ge-matrix3d'
import { UvGeQuaternion } from './uniview-ge-quaternion'
import { UvGeVectorLike } from './uniview-ge-vector'

/**
 * The interface representing a vector in 3-dimensional space.
 */
export interface UvGeVector3dLike {
  /**
 ...
 */
export class UvGeVector3d {
  /**
   * Origin
   */
  static ORIGIN = Object.freeze(new UvGeVector3d(0, 0, 0))
  /**
   * X-Axis
   */
  static X_AXIS = Object.freeze(new UvGeVector3d(1, 0, 0))
  /**
   * Negative X-Axis
   */
  static NEGATIVE_X_AXIS = Object.freeze(new UvGeVector3d(-1, 0, 0))
  /**
   * Y-Axis
   */
  static Y_AXIS = Object.freeze(new UvGeVector3d(0, 1, 0))
  /**
   * Negative Y-Axis
   */
  static NEGATIVE_Y_AXIS = Object.freeze(new UvGeVector3d(0, -1, 0))
  /**
   * Z-Axis
   */
  static Z_AXIS = Object.freeze(new UvGeVector3d(0, 0, 1))
  /**
   * Negative Z-Axis
   */
  static NEGATIVE_Z_AXIS = Object.freeze(new UvGeVector3d(0, 0, -1))
  /**
  ...
  constructor(other: UvGeVectorLike)
  ...
  constructor(a?: unknown, b?: unknown, c?: unknown) {
    ...
    if (argsLength === 1) {
      const { x, y, z } = a as UvGeVectorLike
      this.x = x
      this.y = y
      this.z = z || 0
      return
   ...
   */
  clone() {
    return new UvGeVector3d(this.x, this.y, this.z)
  }
   ...
   * @returns Return this vector
   */
  addVectors(a: UvGeVector3dLike, b: UvGeVector3dLike) {
    this.x = a.x + b.x
    this.y = a.y + b.y
    this.z = a.z + b.z
    return this
   ...
   * @returns Return this vector
   */
  addScaledVector(v: UvGeVector3dLike, s: number) {
    this.x += v.x * s
    this.y += v.y * s
    this.z += v.z * s
    return this
   ...
   * @returns Return this vector
   */
  subVectors(a: UvGeVector3dLike, b: UvGeVector3dLike) {
    this.x = a.x - b.x
    this.y = a.y - b.y
    this.z = a.z - b.z
    return this
   ...
   * @returns Return this vector
   */
  multiplyVectors(a: UvGeVector3dLike, b: UvGeVector3dLike) {
    this.x = a.x * b.x
    this.y = a.y * b.y
    this.z = a.z * b.z
   ...
   * @returns Return this vector
   */
  applyAxisAngle(axis: UvGeVector3dLike, angle: number) {
   ...
   * @returns Return this vector
   */
  applyNormalMatrix(m: UvGeMatrix2d) {
   ...
   * @returns Return this vector
   */
  applyQuaternion(q: UvGeQuaternion) {
   ...
   * @returns
   */
  transformDirection(m: UvGeMatrix3d) {
   ...
   * @returns Return this vector
   */
  clamp(min: UvGeVector3dLike, max: UvGeVector3dLike) {
   ...
   * @returns Return this vector
   */
  lerp(v: UvGeVector3dLike, alpha: number) {
   ...
   * @returns Return this vector
   */
  lerpVectors(v1: UvGeVector3dLike, v2: UvGeVector3dLike, alpha: number) {
   ...
   * @returns Return this vector
   */
  crossVectors(a: UvGeVector3dLike, b: UvGeVector3dLike) {
    const ax = a.x,
      ay = a.y,
      az = a.z
    const bx = b.x,
   ...
   * @returns Return this vector
   */
  projectOnVector(v: UvGeVector3d) {
   ...
   * @returns Return this vector
   */
  projectOnPlane(planeNormal: UvGeVector3d) {
   ...
   * @returns Return this vector
   */
  reflect(normal: UvGeVector3dLike) {
   ...
   */
  distanceToSquared(v: UvGeVector3dLike) {
    const dx = this.x - v.x,
      dy = this.y - v.y,
      dz = this.z - v.z
   ...
   */
  manhattanDistanceTo(v: UvGeVector3dLike) {
    return (
   ...
   * @returns Return this vector
   */
  setFromMatrixPosition(m: UvGeMatrix3d) {
    const e = m.elements
   ...
   * @returns Return this vector
   */
  setFromMatrixScale(m: UvGeMatrix3d) {
   ...
   * @returns Return this vector
   */
  setFromMatrixColumn(m: UvGeMatrix3d, index: number) {
   ...
   * @returns Return this vector
   */
  setFromMatrix3Column(m: UvGeMatrix2d, index: number) {
...
const _vector = /*@__PURE__*/ new UvGeVector3d()
const _quaternion = /*@__PURE__*/ new UvGeQuaternion()
