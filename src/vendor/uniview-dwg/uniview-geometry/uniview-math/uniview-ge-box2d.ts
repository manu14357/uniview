...
export class UvGeBox2d {
   ...
   */
  constructor(
    min: UvGeVector2dLike | undefined = undefined,
    max: UvGeVector2dLike | undefined = undefined
  ) {
    this.min =
      min == null
        ? new UvGeVector2d(+Infinity, +Infinity)
        : new UvGeVector2d(min.x, min.y)
    this.max =
      max == null
        ? new UvGeVector2d(-Infinity, -Infinity)
        : new UvGeVector2d(max.x, max.y)
  }
   ...
   */
  set(min: UvGeVector2dLike, max: UvGeVector2dLike) {
    this.min.copy(min)
    this.max.copy(max)
   ...
   * @returns Return this box
   */
  setFromPoints(points: UvGeVector2dLike[]) {
    this.makeEmpty()
   ...
   * @returns Return this box
   */
  setFromCenterAndSize(center: UvGeVector2dLike, size: UvGeVector2dLike) {
   ...
   */
  clone() {
    return new UvGeBox2d().copy(this)
  }
  ...
  get size() {
    return this.isEmpty()
      ? new UvGeVector2d(0, 0)
      : new UvGeVector2d(0, 0).subVectors(this.max, this.min)
  }
   ...
   * @returns Return this box
   */
  expandByPoint(point: UvGeVector2dLike) {
    this.min.min(point)
    this.max.max(point)
   ...
   * @returns Return this box
   */
  expandByVector(vector: UvGeVector2dLike) {
    this.min.sub(vector)
    this.max.add(vector)
   ...
   */
  containsPoint(point: UvGeVector2dLike) {
   ...
   */
  getParameter(point: UvGeVector2dLike, target: UvGeVector2d) {
   ...
   */
  clampPoint(point: UvGeVector2dLike, target: UvGeVector2d) {
   ...
   */
  distanceToPoint(point: UvGeVector2dLike) {
   ...
   * @returns Return this box
   */
  translate(offset: UvGeVector2dLike) {
    this.min.add(offset)
    this.max.add(offset)
