import * as MathUtils from '../uniview-util'
...
export class UvGeQuaternion {
   ...
   */
  clone() {
    return new UvGeQuaternion(this._x, this._y, this._z, this._w)
  }
   ...
   * @returns Return this quaternion
   */
  copy(quaternion: UvGeQuaternion) {
   ...
   * @returns Return this quaternion
   */
  setFromEuler(euler: UvGeEuler, update = true) {
    const x = euler.x,
      y = euler.y,
      z = euler.z,
      order = euler.order
   ...
   * @returns Return this quaternion
   */
  setFromAxisAngle(axis: UvGeVector3dLike, angle: number) {
   ...
   * @returns Return this quaternion
   */
  setFromRotationMatrix(m: UvGeMatrix3d) {
   ...
   * @returns Return this quaternion
   */
  setFromUnitVectors(vFrom: UvGeVector3d, vTo: UvGeVector3d) {
   ...
   * @returns Return this quaternion
   */
  rotateTowards(q: UvGeQuaternion, step: number) {
   ...
   * @returns Return this quaternion
   */
  multiplyQuaternions(a: UvGeQuaternion, b: UvGeQuaternion) {
   ...
   * @returns Return this quaternion
   */
  slerp(qb: UvGeQuaternion, t: number) {
    if (t === 0) return this
   ...
   * @returns Return this quaternion
   */
  slerpQuaternions(qa: UvGeQuaternion, qb: UvGeQuaternion, t: number) {
   ...
   */
  equals(quaternion: UvGeQuaternion) {
    return (
