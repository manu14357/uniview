import { UvGeBox2d, UvGePoint3d } from '@uniview/geometry'

/**
 * Interface for viewport state providing viewing characteristics of a viewport.
 */
export interface IUvGiViewport {
  ...
  readonly centerPoint: UvGePoint3d
  /** The height of the viewport entity's window in drawing units. */
  readonly height: number
  /** The width of the viewport entity's window in drawing units. */
  readonly width: number
  /** The bounding box (in WCS coordinates) of the viewport. */
  readonly box: UvGeBox2d
  /** The view center (in DCS coordinates) of the view in the viewport. */
  readonly viewCenter: UvGePoint3d
  /** The height (in DCS coordinates) of the Model Space view within the viewport. */
  readonly viewHeight: number
  /** The width (in DCS coordinates) of the Model Space view within the viewport. */
  readonly viewWidth: number
  /** The bounding box (in DCS coordinates) of the Model Space view within the viewport. */
  readonly viewBox: UvGeBox2d
  /** Clone this viewport. */
  clone(): UvGiViewport
  /** Copy the property values of the passed viewport to this viewport. */
  copy(viewport: UvGiViewport): UvGiViewport
}

/**
 * This class is used to pass back information to the user about the viewing characteristics of the
 * current viewport.
 */
export class UvGiViewport implements IUvGiViewport {
  private _centerPoint: UvGePoint3d
  private _height: number
  private _width: number
  private _viewCenter: UvGePoint3d
  ...
  constructor() {
    ...
    this._id = ''
    this._groupId = ''
    this._centerPoint = new UvGePoint3d()
    this._height = 0
    this._width = 0
    this._viewCenter = new UvGePoint3d()
    this._viewHeight = 0
  }
  ...
  set viewCenter(value: UvGePoint3d) {
   ...
   */
  clone() {
    const viewport = new UvGiViewport()
    viewport.id = this.id
