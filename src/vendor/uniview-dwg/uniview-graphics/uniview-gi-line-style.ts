import { UvGiStyleType } from './uniview-gi-style-type'

import { UvGiArrowType } from './uniview-gi-arrow-type'

/**
 * Line type pattern element
 */
export interface UvGiLineTypePatternElement {
 ...
 * Arrow style
 */
export interface UvGiArrowStyle {
  /**
   * Arrow type.
   */
  type: UvGiArrowType
...
export interface UvGiBaseLineStyle {
   ...
   * Line type pattern
   */
  pattern?: UvGiLineTypePatternElement[]
}

/**
 * Line style
 */
export interface UvGiLineStyle extends UvGiBaseLineStyle {
  /**
